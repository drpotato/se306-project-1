...
class ActorListBuilder:
    ...
    def getStageEnd(self):
        outStrList = []
        outStrList.append("# This file is automatically generated by se306_p1_package/world/updateactors.py\n")
        default = "default"
        usedActors = set()
    ...
    def getBashEnd(self):
        ...
        for i in range(len(self.actors)):
            actor = self.actors[i]
            outStrList.append("rosrun se306_p1_package ActorSpawner %d %s & ROBOT%d_PID=$!\n" % (i, actor[0], i))
