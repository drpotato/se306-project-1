...
echo InitialX       = -7.3 >> log/actor_MedicationRobot_000.txt
echo InitialY       = 0 >> log/actor_MedicationRobot_000.txt
...
rosrun se306_p1_pkg ActorSpawner 6 MedicationRobot -7.3 0 0 & # >> log/actor_MedicationRobot_000.txt &
ROBOT6_PID=$!
